...
class Geocoder:
    ...
    def get_coordinates(
        ...
        coordinates of the normalized location passed in input. The resulting
        dictionaries are composed of a normalized name (field "name"), four
        gps coordinates of the two corners of its bounding box (field "extent"),
    ...
    def double_check_countries(
        ...
        The function returns a dictionary that can be used to map every
        location in the list to the respective inferred country.
